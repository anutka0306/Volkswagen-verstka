<header class="header_main container-fluid">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-3 col-8 d-md-flex justify-content-xl-center justify-content-start align-items-center">
                <span class="header_logo"></span>
                <p class="mb-0 ms-3"><span class="fw-normal">Ремонт и обслуживание автомобилей </span>Volkswagen</p>
            </div>
            <div class="col-md-3 d-xl-flex d-none align-items-center justify-content-center">
                <?php include "menu.php";?>
            </div>
            <div class="col-xl-4 col-lg-4 d-xl-flex d-none justify-content-around">
            ...
            <div class="col-xl-2 col-1 d-xl-none d-block">
