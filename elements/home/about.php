<section class="about container-fluid">
    <h2>Сервис Фольксваген в Санкт-Петербурге.
    </h2>
    <div class="about_container">
        <div class="about_container_left">
            ...
            <span class="cincerely">С уважением, команда СТО VW Volkswagen
                    </span>
        </div>

        <div class="about_container_right"><img src="./img/volkswagen-b6.png" alt="volkswagen-b6"></div>
    </div>
</section>